...
# 747   CT2    Sullivan Square Station - Ruggles Station
# 708   CT3    Beth Israel Deaconess Hospital - Andrew Station
...
route_tar <- c("CR-Lowell") #Use route_ids , not the full route names. Run 1-22 and see dat$routes for more information. 
